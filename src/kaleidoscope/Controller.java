...
public class Controller extends JFrame {
	...
	private void init() {
		...
		for (int i = 0; i < MODELS_NUM; i++) {
			...
			if (i % 5 == 0) toAdd.setShapeType("ball");
			else if (i % 5 == 1) toAdd.setShapeType("rectangle");
			else if (i % 5 == 2) toAdd.setShapeType("triangle");
			else if (i % 5 == 3) toAdd.setShapeType("roundRect");
			else toAdd.setShapeType("diamond");
